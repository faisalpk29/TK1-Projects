 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://test.com", wsdlLocation = "http://localhost:8095/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://test.com", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8095/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloPort() {
        return super.getPort(new QName("http://test.com", "HelloPort"), HelloWorld.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloPort")
    public HelloWorld getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com", "HelloPort"), HelloWorld.class, features);
    }
